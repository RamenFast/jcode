...
impl Tool for BashTool {
    ...
    async fn execute(&self, input: Value, ctx: ToolContext) -> Result<ToolOutput> {
        ...
        // FEEDBACK.md intentionally keeps shell access permissive. High-impact
        // commands proceed normally after publishing visible, non-blocking UI
        // and audit feedback.
        high_impact::publish_notice(&params.command, params.intent.as_deref(), &ctx);
